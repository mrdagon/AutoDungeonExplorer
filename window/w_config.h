...
namespace SDX_ADE
{
	...
	public:
		...
		void Init()
		{
			...
			{
				仮_フォント種++;
				if (仮_フォント種 >= MFont::フォント数)
				{
					仮_フォント種 = 0;
				}
				フォント種.設定値 = TX::Config_フォント設定[仮_フォント種];
			};
