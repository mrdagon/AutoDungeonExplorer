	...
	private:
		...
		public:
			...
			void Draw派生() override
			{
				...
				it->image->DrawRotate({ GetCenterX() - 24 , GetCenterY() }, 1, 0);

				GetFont()->DrawRotateEdge({ GetCenterX() + 12 , GetCenterY() }, 1, 0, Design::明字, { "★ " , it->ランク });
			}
