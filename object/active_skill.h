...
namespace SDX_ADE
{
	...
	public:
		...
		double 基礎効果 = 0;//固定ダメージとか
		double 反映率 = 0;//ステータス反映率
		...
		static void LoadData()
		{
			...
			ActiveSkill::data[0].Set(ASkillTarget::その他, StatusType::筋力, DamageType::物理, ASkillType::指定なし);
			...
			ActiveSkill::data[1].装備種 = ItemType::大剣;
			ActiveSkill::data[2].装備種 = ItemType::大剣;
			...
			ActiveSkill::data[7].装備種 = ItemType::大盾;
			ActiveSkill::data[8].装備種 = ItemType::大盾;
			ActiveSkill::data[9].装備種 = ItemType::書物;
			ActiveSkill::data[10].装備種 = ItemType::書物;
			...
			ActiveSkill::data[3].Set(ASkillTarget::敵前 , StatusType::筋力, DamageType::物理 ,ASkillType::物理);
			ActiveSkill::data[4].Set(ASkillTarget::敵前 , StatusType::筋力, DamageType::物理 , ASkillType::物理);
			ActiveSkill::data[5].Set(ASkillTarget::敵ランダム, StatusType::技力, DamageType::物理 , ASkillType::物理);
			ActiveSkill::data[6].Set(ASkillTarget::敵弱者 , StatusType::技力, DamageType::物理, ASkillType::物理);
			ActiveSkill::data[7].Set(ASkillTarget::敵前 , StatusType::筋力, DamageType::物理, ASkillType::物理);
			ActiveSkill::data[8].Set(ASkillTarget::自分   , StatusType::筋力, DamageType::物理 , ASkillType::バフ);
			...
			ActiveSkill::data[9].Set(ASkillTarget::敵ランダム, StatusType::知力, DamageType::魔法, ASkillType::魔法);
			ActiveSkill::data[10].Set(ASkillTarget::敵全, StatusType::知力, DamageType::魔法, ASkillType::魔法);
			ActiveSkill::data[11].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[12].Set(ASkillTarget::味方弱者, StatusType::知力, DamageType::魔法, ASkillType::回復 );
		
			ActiveSkill::data[13].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[14].Set(ASkillTarget::敵前ランダム, StatusType::知力, DamageType::魔法, ASkillType::魔法 );
			ActiveSkill::data[14].範囲 = 3;
			ActiveSkill::data[15].Set(ASkillTarget::敵前ランダム, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[15].範囲 = 3;
			ActiveSkill::data[16].Set(ASkillTarget::敵ランダム, StatusType::知力, DamageType::魔法, ASkillType::魔法 );
			ActiveSkill::data[17].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[18].Set(ASkillTarget::敵後ランダム, StatusType::技力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[18].範囲 = 2;
			ActiveSkill::data[19].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[20].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			ActiveSkill::data[20].範囲 = 3;
			ActiveSkill::data[21].Set(ASkillTarget::敵全, StatusType::知力, DamageType::魔法, ASkillType::魔法 );
			...
			ActiveSkill::data[22].Set(ASkillTarget::敵前ランダム , StatusType::筋力, DamageType::物理, ASkillType::物理 );
			...
			ActiveSkill::data[23].Set(ASkillTarget::敵前, StatusType::筋力, DamageType::物理, ASkillType::物理 );
			...
			ActiveSkill::data[24].Set(ASkillTarget::自分, StatusType::筋力, DamageType::物理, ASkillType::バフ);
			...
			ActiveSkill::data[25].Set(ASkillTarget::味方全員, StatusType::筋力, DamageType::物理, ASkillType::バフ);
			...
			ActiveSkill::data[26].Set(ASkillTarget::敵ランダム, StatusType::技力, DamageType::物理, ASkillType::物理);
			ActiveSkill::data[26].SetP(2, 0, 1.5, 0.7, 0, 400);
			ActiveSkill::data.emplace_back(27, "マジカルアロー", "ランダムに6回 DEXx200% 魔法ダメージ", SkillType::弓);
			ActiveSkill::data[27].Set(ASkillTarget::敵ランダム, StatusType::技力, DamageType::魔法, ASkillType::物理);
			ActiveSkill::data[27].SetP(6, 0, 2.0, 0.6, 0, 1000, true);

			//ウィザード
			ActiveSkill::data.emplace_back(28, "集中", "400Tの間、自身の INT+30% 上昇", SkillType::INT);
			ActiveSkill::data[28].Set(ASkillTarget::自分, StatusType::知力, DamageType::魔法, ASkillType::バフ);
			...
			ActiveSkill::data[29].Set(ASkillTarget::敵全, StatusType::知力, DamageType::魔法 , ASkillType::魔法);
			ActiveSkill::data[29].SetP(1, 0, 4.0, 1.2, 0, 1000, true);

			//クレリック
			ActiveSkill::data.emplace_back(30, "祝福", "弱った味方一人のHPを INTx200% 回復", SkillType::回復);
			ActiveSkill::data[30].Set(ASkillTarget::味方弱者, StatusType::知力, DamageType::魔法, ASkillType::回復);
			ActiveSkill::data[30].SetP(1, 0, 2.0, 1.0, 0, 400);
			ActiveSkill::data.emplace_back(31, "奇跡", "味方全員のHPを INTx150% 回復", SkillType::回復);
			ActiveSkill::data[31].Set(ASkillTarget::味方全員, StatusType::知力, DamageType::魔法, ASkillType::回復);
