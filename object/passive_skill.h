...
namespace SDX_ADE
{
	...
	public:
		...
		static void LoadData()
		{
			...
			PassiveSkill::data.emplace_back(13, "剣技", "剣スキル 威力+15%", SkillType::剣, ItemType::大剣, ASkillType::指定なし );
			PassiveSkill::data.emplace_back(14, "剣術", "剣スキル CT+10%"  , SkillType::剣, ItemType::大剣, ASkillType::指定なし	);
			PassiveSkill::data.emplace_back(15, "斧技", "斧スキル 威力+15%", SkillType::斧, ItemType::大剣, ASkillType::指定なし);
			PassiveSkill::data.emplace_back(16, "斧術", "斧スキル CT+10%", SkillType::斧, ItemType::大剣, ASkillType::指定なし);
			...
			PassiveSkill::data.emplace_back(19, "魔技", "魔杖スキル 威力+15%", SkillType::魔杖, ItemType::書物, ASkillType::指定なし);
			PassiveSkill::data.emplace_back(20, "魔術", "魔杖スキル CT+10%", SkillType::魔杖, ItemType::書物, ASkillType::指定なし);
			...
			PassiveSkill::data.emplace_back(23, "盾技", "盾スキル 効果+15%", SkillType::盾, ItemType::大盾, ASkillType::指定なし);
			PassiveSkill::data.emplace_back(24, "盾術", "盾スキル CT+10%", SkillType::盾, ItemType::大盾, ASkillType::指定なし);
			PassiveSkill::data.emplace_back(25, "盾術", "盾スキル 持続+15%", SkillType::盾, ItemType::大盾, ASkillType::指定なし);
			...
			PassiveSkill::data[34].Set(5, 0.10, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			PassiveSkill::data[35].Set(5, 0.15, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			...
			PassiveSkill::data[38].Set(5, 0.10, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			PassiveSkill::data[39].Set(8, 0.15, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			...
			PassiveSkill::data[42].Set(4, 0.10, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			PassiveSkill::data[43].Set(7, 0.15, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::スキル威力増減);
			...
			PassiveSkill::data[53].Set(3, 0.03, 1.0, PSkillTime::常時, PSkillIf::条件無し, PSkillTarget::その他, PSkillEffect::レア剥取率増加);
			PassiveSkill::data[54].Set(5, 0.05, 1.0, PSkillTime::常時, PSkillIf::条件無し, PSkillTarget::その他, PSkillEffect::レア剥取率増加);
			...
			PassiveSkill::data[61].Set(5, 30, 1.0, PSkillTime::戦闘開始時, PSkillIf::条件無し, PSkillTarget::自分, PSkillEffect::クールタイム獲得);
			PassiveSkill::data[62].Set(5, 0.25, 1.0, PSkillTime::スキル使用時, PSkillIf::敵の数が一定以下, PSkillTarget::スキル対象, PSkillEffect::スキル威力増減);
			PassiveSkill::data[63].Set(5, 0.1, 1.0, PSkillTime::スキル使用時, PSkillIf::条件無し, PSkillTarget::スキル対象, PSkillEffect::与ダメージバフ);
